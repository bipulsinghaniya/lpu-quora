...
//       {/* Header */}
//       <header className="bg-white/80 backdrop-blur-md shadow-sm border-b-2 border-orange-500 relative z-10 animate-slideDown">
...
//           <div className="bg-white/90 backdrop-blur-sm border-2 border-orange-200 rounded-2xl p-10 shadow-2xl transform transition-all duration-300 hover:shadow-3xl">
//             {/* Welcome Text */}
//             <div className="text-center mb-8">
//               <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-orange-100 to-orange-200 rounded-full mb-4 animate-bounce-slow">
...
//             {error && (
//               <div className="bg-red-50 border-2 border-red-300 text-red-800 px-5 py-4 rounded-xl mb-6 animate-shake flex items-start gap-3">
...
//             <div className="space-y-6">
//               {/* Email Input */}
//               <div className="transform transition-all duration-300 focus-within:scale-[1.02]">
//                 <label className="block text-sm font-bold text-gray-800 mb-2">
//                   Email Address
//                 </label>
...
//                     type="email"
//                     placeholder="your.email@example.com"
//                     className="w-full pl-12 pr-4 py-3 border-2 border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:border-orange-500 focus:ring-4 focus:ring-orange-100 transition-all duration-300"
//                     value={email}
//                     onChange={(e) => setEmail(e.target.value)}
...
//                     placeholder="Enter your password"
//                     className="w-full pl-12 pr-12 py-3 border-2 border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:border-orange-500 focus:ring-4 focus:ring-orange-100 transition-all duration-300"
//                     value={password}
//                     onChange={(e) => setPassword(e.target.value)}
//                     onKeyPress={handleKeyPress}
//                   />
...
//                 onClick={handleLogin}
//                 disabled={loading}
//                 className="w-full bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-bold py-4 px-4 rounded-xl transform transition-all duration-300 hover:scale-[1.02] hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
//               >
//                 {loading ? (
//                   <>
...
//               <a href="#" className="text-orange-600 hover:text-orange-700 font-medium text-sm hover:underline transition-all">
//                 Forgot password?
//               </a>
//             </div>
...
//         <div className="relative z-10 text-center text-white max-w-lg animate-fadeIn">
//           {/* Brand Badge */}
...
//           {/* Main Heading */}
//           <h1 className="text-6xl font-bold mb-6 animate-slideUp" style={{ animationDelay: '0.2s' }}>
//             Hello, Friend! 👋
//           </h1>

//           {/* Description */}
//           <p className="text-xl text-blue-100 mb-10 leading-relaxed animate-slideUp" style={{ animationDelay: '0.3s' }}>
//             Enter your personal details and start your learning journey with us
//           </p>

//           {/* Sign Up Button */}
//           <Link to="/register">
//             <button className="bg-white text-blue-600 font-bold py-4 px-12 rounded-2xl hover:bg-blue-50 transform transition-all duration-300 hover:scale-105 shadow-2xl text-lg animate-slideUp" style={{ animationDelay: '0.4s' }}>
//               SIGN UP
//             </button>
//           </Link>
