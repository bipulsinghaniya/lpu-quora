...
//     await api.post(`/questions/${q._id}/answer`, { text: answer });
//     setAnswer("");
//     reload();
//   };
...
//         >
//           {show ? "Hide answers" : `Show answers (${q.answers.length})`}
//         </button>
//       )}

//       {show && <AnswerList answers={q.answers} reload={reload} />}
//     </div>
//   );
// }
...
//     setAnswer("");
//     reload(); // ✅ refresh questions correctly
//   } catch (err) {
